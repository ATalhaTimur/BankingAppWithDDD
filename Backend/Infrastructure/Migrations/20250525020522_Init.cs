...
namespace Infrastructure.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ExternalTransferLogs",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    FromAccountId = table.Column<Guid>(type: "uuid", nullable: false),
                    ToIban = table.Column<string>(type: "character varying(26)", maxLength: 26, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExternalTransferLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExternalTransferLogs_Accounts_FromAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalTransferLogs_FromAccountId",
                table: "ExternalTransferLogs",
